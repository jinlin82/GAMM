...
```{r eval=F}
library(gammSlice)
fit1<-gSlc(y~x,random=list(idnum=~x),family="binomial")
```
...
```{r fig1,eval=T,echo=F,fig.cap="基于MCMC抽样的简单logistic回归模型的信息总结",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\fig1-logistic.png")
```
...
```{r fig2,eval=T, echo=F,fig.cap="有效自由度的MCMC输出信息汇总",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\fig2-poisson.png")
```


```{r fig3,eval=T, echo=F,fig.cap="贝叶斯后验密度均值和95%的置信区间",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\fig2-poisson1.png")
```
...
```{r fig4,eval=T, echo=F,fig.cap="基于切片MCMC抽样的信息总结",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\fig3-semi_logistic.png")
```
...
```{r fig5,eval=T, echo=F,fig.cap="f的贝叶斯后验均值估计及95%置信区间",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\fig3-semi_logistic1.png")
```
...
```{r fig6,eval=T, echo=F,fig.cap="基于切片MCMC抽样的模型拟合信息总结",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\fig4-poisson_mix.png")
```

高的有效自由度反映出拟合函数部分的非线性性。非线性效应在图 \@ref(fig:fig7)中进一步加强。

```{r fig7,eval=T, echo=F,fig.cap="f1和f2的贝叶斯后验均值估计及95%的置信区间",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\fig4-poisson_mix1.png")
```
...
```{r fig10,eval=T, echo=F,fig.cap="基于切片MCMC抽样拟合logistic混合模型的信息汇总",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\fig5-toenail.png")
```
...
```{r fig12,eval=T, echo=F,fig.cap="基于切片MCMC抽样的拟合logistic可加混合模型的信息汇总",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\fig6-disease.png")
```
...
```{r fig13,eval=T, echo=F,fig.cap="f(age)的贝叶斯后验均值估计及95%的置信区间",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\fig6-disease.png")
```
