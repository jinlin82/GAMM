...
因此，方差参数的更新可以通过简单的Gibbs抽样进行，从反伽马的密度函数中直接提取。同样快速的实
...
\\ \beta \sim \mathrm{N}\left(0, \sigma_{\beta}^{2} \boldsymbol{I}\right), \quad \sigma_{\ell}\stackrel{\mathrm{ind}}{\sim} \text { Half-Cauchy }\left(A_{\ell}\right), 1 \leqslant \ell \leqslant L \end{array}$$ {#eq:m-18-14}
...
自 $\mathcal{H}_{b}\left(s_{1}, s_{2}, \boldsymbol{s}_{3},\boldsymbol{s}_{4}\right)$ 的抽样过程。
