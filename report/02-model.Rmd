...
后者是 **localweighted regression**的简称。这两种光滑器在几个方面都比
...
Y=f(X_{1},\cdots,X_{k})+\varepsilon.$$
...
$$\boldsymbol z | \boldsymbol{b}, \boldsymbol{\beta} \sim N\left(\boldsymbol{X}
  ...
  \phi\right), \boldsymbol{b} \sim N\left(\boldsymbol{0}, \boldsymbol \psi_{\theta}\right)$$
...
$$\boldsymbol{f} | \boldsymbol{B} \sim N(\boldsymbol{R} \mathcal{B}, \boldsymbol{I} \phi) \quad \text {其中 } \boldsymbol{b} \sim N\left(\mathbf{0}, \boldsymbol \psi_{\theta}\right)$$
