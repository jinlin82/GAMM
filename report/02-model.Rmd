...
$$\label{eq:12}
  y=\alpha+\beta_{1}x+\beta_{2}x^{2}+\cdots+\beta_{p}x^{p}+\varepsilon.$$
...
$$\label{eq:13}
  ...
  +\beta_{p}\frac{x_{i}^{p}}{w_{i}}+\frac{\varepsilon_{i}}{w_{i}},$$
...
$$\boldsymbol z | \boldsymbol{b}, \boldsymbol{\beta} \sim \mathcal{N}\left(\boldsymbol{X}
  ...
  \phi\right), \boldsymbol{b} \sim \mathcal{N}\left(\boldsymbol{0}, \boldsymbol \psi_{\theta}\right)$$
