...
对象，利用半参数混合效应模型对城市空气质量的影响因素进行研究。该模型综合考虑了自
变量对因变量的线性和非线性固定效应以及描述观测值数据相关性的随机效应。研究结果显
示，对于年均AQI，社会经济因素中的废气治理完成投资额是正的线性影响，固定资产投资
和汽车拥有量是非线性关系；气候因素中的平均风速是线性关系，平均气温具有非线性关系;是
否临海，是否供暖和纬度三个地理因素对年均AQI有线性影响。对于月均AQI，社会经济方面
的三个影响因素废气治理完成投资额，房屋建筑施工面积和汽车拥有量均为线性影响；平均
气温，降水量，平均风速和平均气压这四个气象变量对月均AQI均有显著的线性影响；地理
因素中的是否临海，是否供暖是线性影响，纬度对月均AQI有显著的非线性影响。
...
其中 $y_{i}$ 是因变量， $\boldsymbol{\beta}$ 是固定效应参数向量，
 ...
 $\varepsilon_{i}$ 堆积而成，一般假设其方差协方差矩阵具有比较简单的形式。
