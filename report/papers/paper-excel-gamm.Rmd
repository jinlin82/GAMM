...
对空气质量进行研究，已有文献主要集中在以下三类。第一类直接以空气质量指数为研究对
象，运用时间序列研究方法以及支持向量机、BP神经网络等算法对未来的空气质量指数进行
预测[@刘威2013;@闫妍2013;@胡世前2016]。第二类注重从时空演变角度出发注重探究空气
质量的时空演变特征[@黄小刚2019;@柏玲2018]。第三类是空气质量影响因素分析。在进行
影响因素分析时，因变量设置也有所不同，一类是以SO2等空气污染物为研究对象，以空气
污染物排放量表征空气质量，进而进行影响因素分析[@李陈2016]，另一类是以空气质量指
数AQI作为因变量。并且选取的影响因素侧重点不同，一部分研究侧重社会经济因素的影响
[@柏玲2018;@王超2019;@郭一鸣2019;@吴雪萍2018],也有研究单独从气候或气象等自然因素
出发进行影响因素研究[@周文博2019;@Rafael2019]，还有部分学者综合考虑社会经济因素、
自然因素，并将空气主要污染物作为自变量进行分析而不是因变量[@李桂兰2019]。所用方
法主要为多元回归、灰色关联度分析、空间分析方法[@柏玲2018;@王超2019;@王乐2019;@郭一鸣2019;@吴雪萍2018]
