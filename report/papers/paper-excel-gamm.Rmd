...
output:
  bookdown::pdf_document2:
    ...
    pandoc_args: ["--listing", "--bibliography=Bibfile_e", "--filter", "pandoc-crossref"]
...
```{r fig-dep-norm, echo=FALSE, fig.cap=" 空气质量为优天数Q-Q图", fig.height=2.5, fig.pos="h", fig.width=6.5, dev=c("png","cairo_pdf"), dev.args=list(family="Microsoft YaHei UI Light"), list(family="Microsoft, out.width="95%")}
rm(list=ls())
library(car)
