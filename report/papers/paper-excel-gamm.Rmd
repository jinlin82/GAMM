...
分别建立线性回归模型(模型I)、线性混合效应模型(模型II)、半参数回归模型(模型III)和半参数混合效应模型(模型IV)对空气
质量的影响因素进行分析。根据以上分析结果可知，在线性回归模型(模型I)中，显著的变量有废气
...
量，分别建立泊松回归模型(模型I)、泊松混合效应模型(模型II)、泊松可加模型(模型III)和泊松可加混合效应模型(模型IV)对
空气质量为优天数的影响因素进行分析。根据以上分析结果可知，在泊松回归模型(模型I)中，显著
...
义，泊松可加模型(模型III)对于月度空气质量为优天数的拟合最好。但在上面建立的泊松可加模型(模型III)中，
